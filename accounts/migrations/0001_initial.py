    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address1', models.TextField(null=True, validators=[accounts.models.validate_address], verbose_name='address 1')),
                ...
                ('zip_code', models.CharField(max_length=6, null=True, validators=[accounts.models.validate_zip], verbose_name='zip code')),
